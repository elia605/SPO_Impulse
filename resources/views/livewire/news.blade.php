                        ...
                        <table class="table">
                            ...
                            @foreach ($news as $new)
                                <tr>
                                    ...
                                    <td class="pl-0 pr-0"><input class="btn btn-warning btn-sm" value="E" type="button" wire:click="editNews({{$new}})" data-toggle="modal" data-target="#exampleModalCenter"></td>
                                    <td class="pl-0 pr-0"><input class="btn btn-danger btn-sm" value="X" type="button" wire:click="deleteNews({{$new}})"></td>
                                </tr>
                            @endforeach
                        </table>
                    </div>
